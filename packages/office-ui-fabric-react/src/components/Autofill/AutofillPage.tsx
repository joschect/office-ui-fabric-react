...
import { AutofillStatus } from './Autofill.checklist';
import { AutofillExample } from './examples/Autofill.Example';
import { GhostAutofillExample } from './examples/GhostAutofill.Example';

const AutofillExampleCode = require('!raw-loader!office-ui-fabric-react/src/components/Autofill/examples/Autofill.Example.tsx') as string;
const GhostAutofillExampleCode = require('!raw-loader!office-ui-fabric-react/src/components/Autofill/examples/GhostAutofill.Example.tsx') as string;

export class AutofillPage extends React.Component<IComponentDemoPageProps, any> {
  public render() {

    return (
      <ComponentPage
        title={ 'Autofill' }
        componentName='AutofillExample'
        exampleCards={
          <div>
            <ExampleCard title='Default Autofill' code={ AutofillExampleCode }>
              <AutofillExample />
            </ExampleCard>
            <ExampleCard title='Ghost Autofill' code={ AutofillExampleCode }>
              <GhostAutofillExample />
            </ExampleCard>
          </div>
        }
        propertiesTables={
          <div>
            <PropertiesTableSet
              sources={ [
                require<string>('!raw-loader!office-ui-fabric-react/src/components/AutoFill/Autofill.types.ts')
              ] }
            />
